...
// Files to skip (they were hand-tuned)
...
const newMobileStyles = `    <!-- Auto-injected Mobile Overrides -->
    <style>
        ...
        .a4-page, .page-container, .document-wrapper, #document-wrapper, #content-root {
            width: 100% !important;
            ...
            padding: 24px 16px !important; /* Fix oversized padding */
        }
        ...
        .gap-6, .gap-8 { gap: 16px !important; }
        ...
        * { word-wrap: break-word; }
        .text-justify { text-align: left !important; } /* Justify looks bad on mobile */
        p { 
...
files.forEach(file => {
    ...
    console.log("Optimized layout for " + file);
});

console.log('Mobile layout optimization pass completed.');
