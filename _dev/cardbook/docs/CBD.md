...
- **美學類型**: 寶可夢滿版插畫卡牌 (PTCG)
- **美學維度說明**:
  - **構圖設計**: 滿版插畫 (Full Art) 構圖，主圖片鋪滿全卡，角色有強烈的透視線與向外突破的動態感，以營造三維空間深度。
  - **字體選用 (建議)**: 標題使用圓潤易讀無襯線體，技能與描述字體使用等寬字體方便數值對齊。
  - **主圖片視覺**: 雷電噴火龍，巨龍渾身纏繞著藍色的雷電，在風暴的雲層中咆哮，雷光照亮牠的翅膀，具有高度細緻的奇幻插畫風。
  - **色調規劃**: 高彩度、高飽和度的電藍色與火紅色碰撞，背景帶有雷射折射光澤 (Vibrant holographic reflection overlay)。
- **繪圖 Prompt**: `Full art PTCG style illustration of a fierce Charizard dragon engulfed in crackling blue lightning, soaring through storm clouds, dynamic perspective action pose, glowing eyes, vivid holographic reflection overlay, highly detailed fantasy digital art, vertical card aspect ratio, 5:7 aspect ratio, portrait orientation`
- **圖片路徑**:
  - **主圖**: `_dev/cardbook/images/cb_001_thunder_charizard_img.png`
  - **合成卡牌**: `_dev/cardbook/images/cb_001_thunder_charizard_card.png`
...
- **美學類型**: 寶可夢滿版插畫卡牌 (PTCG)
- **美學維度說明**:
  - **構圖設計**: 滿版插畫 (Full Art) 構圖，皮卡丘位於中央偏下，右手握畫筆，營造向外突破的立體張力。
  - **字體選用 (建議)**: 標題使用粗體無襯線體，下方描述與數值使用緊湊易讀的等寬字體。
  - **主圖片視覺**: 皮卡丘作為插畫大師的開心肖像，身邊擺滿水彩顏料與墨水，畫風充滿童趣且高精細。
  - **色調規劃**: 溫暖活潑的馬卡龍色系，黃色、粉色、天藍色交織，配合閃卡折射光譜背景。
- **繪圖 Prompt**: `Vibrant PTCG style illustration of a happy chubby Pikachu as an artist holding a paintbrush, painting a colorful drawing of Jigglypuff, surrounded by tubes of watercolor paint, splattered ink, pastel color palette, soft glowing background, vertical card aspect ratio, 5:7 aspect ratio, portrait orientation, no text`
- **圖片路徑**:
  - **主圖**: `_dev/cardbook/images/cb_002_illustrator_pikachu_img.png`
  - **合成卡牌**: `_dev/cardbook/images/cb_002_illustrator_pikachu_card.png`
...
- **美學類型**: 寶可夢滿版插畫卡牌 (PTCG)
- **美學維度說明**:
  - **構圖設計**: 經典復刻構圖，皮卡丘居中，展現手繪感之背景。
  - **字體選用 (建議)**: 品牌使用易讀無襯線體，下方數據使用等寬字體以便對齊。
  - **主圖片視覺**: 胖嘟嘟早期畫風，手繪色鉛筆質感，皮卡丘無辜站在草地上。
  - **色調規劃**: 經典綠色與黃色的自然色調，搭配早期星芒雷射折射效果。
- **繪圖 Prompt**: `Classic 1990s anime style illustration of a chubby yellow Pikachu with red cheeks, standing in a lush green forest field, early official Pokemon art style, crayon-like soft texture, background has a vintage holographic starburst foil reflection pattern, vertical card aspect ratio, 5:7 aspect ratio, portrait orientation, no text`
- **圖片路徑**:
  - **主圖**: `_dev/cardbook/images/cb_003_base_set_pikachu_img.png`
  - **合成卡牌**: `_dev/cardbook/images/cb_003_base_set_pikachu_card.png`
...
- **類別**: 角色卡
- **系列名稱**: 經典蒐藏
- **美學類型**: 寶可夢滿版插畫卡牌 (PTCG) / 金融奢華風格
- **美學維度說明**:
  - **構圖設計**: 極簡黃金比例，中央為立體雕刻皮卡丘，大面積拉絲金色留白。
  - **字體選用 (建議)**: 使用極細無襯線字體，彰顯時尚與高貴感。
  - **主圖片視覺**: 浮雕質感的 24K 純金皮卡丘肖像，表面有細緻的拉絲與光影。
  - **色調規劃**: 頂級奢華的單色金色調，亮金與暗金色光線折射。
- **繪圖 Prompt**: `Luxurious 24K solid gold relief sculpture of Pikachu, metallic gold brushed texture, minimalist gold-on-gold design, elegant geometric anniversary emblem in background, premium card design style, vertical card aspect ratio, 5:7 aspect ratio, portrait orientation, no text`
- **圖片路徑**:
  - **主圖**: `_dev/cardbook/images/cb_004_gold_pikachu_img.png`
  - **合成卡牌**: `_dev/cardbook/images/cb_004_gold_pikachu_card.png`
...
- **美學類型**: 遊戲與蒐藏類 (TCG)
- **美學維度說明**:
  - **構圖設計**: 圓形外框，龍頭與翅膀突破外框，具備強烈的「出框感 (Pop-out 3D)」立體張力。
  - **字體選用 (建議)**: 使用毛筆或粗獷裝飾性黑體，彰顯力量感。
  - **主圖片視覺**: 巨龍身披白銀色鱗片，嘴裡凝聚著藍色光能，在魔法陣宇宙背景中咆哮，細緻奇幻。
  - **色調規劃**: 經典白銀與淡藍色龍身，深藍色宇宙背景，金色符文點綴。
- **繪圖 Prompt**: `Classic TCG Yu-Gi-Oh style illustration of the legendary Blue-Eyes White Dragon breaking out of a circular magical rune frame, head and wings pop out 3D effect, breathing glowing blue energy blast, white silver metallic dragon scales, dark cosmic deep blue background with magical circles, vertical card aspect ratio, 5:7 aspect ratio, portrait orientation, no text`
- **圖片路徑**:
  - **主圖**: `_dev/cardbook/images/cb_005_blue_eyes_img.png`
  - **合成卡牌**: `_dev/cardbook/images/cb_005_blue_eyes_card.png`
...
- **美學類型**: 遊戲與蒐藏類 (TCG)
- **美學維度說明**:
  - **構圖設計**: 對稱與中心輻射構圖，創世神明居中，身後散發萬丈金色光芒與巨大神聖光環。
  - **字體選用 (建議)**: 使用神聖古典感襯線體，凸顯極致的稀有度。
  - **主圖片視覺**: 融合古埃及與奇幻動漫風格的女神肖像，身披黃金盔甲與七彩羽翼。
  - **色調規劃**: 輝煌炫目的黃金與純白，搭配背景高亮金黃色光芒折射。
- **繪圖 Prompt**: `Classic TCG Yu-Gi-Oh style illustration of Holactie the Creator of Light, a divine goddess wearing ornate golden armor and multi-colored wings of light, standing majestically, radiant golden aura and massive halos radiating outward, ancient Egyptian gold runes, highly detailed fantasy digital art, vertical card aspect ratio, 5:7 aspect ratio, portrait orientation, no text`
- **圖片路徑**:
  - **主圖**: `_dev/cardbook/images/cb_006_holactie_img.png`
  - **合成卡牌**: `_dev/cardbook/images/cb_006_holactie_card.png`
- **建立時間**: `2026-07-16 09:34:37`

### [CB-007] 大谷翔平 投球姿態 (Ohtani Shohei - Pitching Pose)

- **ID**: `CB-007`
- **中文名稱**: 大谷翔平 投球姿態
- **英文名稱**: Ohtani Shohei - Pitching Pose
- **類別**: 運動卡
- **系列名稱**: MLB 球星
- **美學類型**: 運動卡 (Sports Card)
- **美學維度說明**:
  - **構圖設計**: 非對稱「動態肖像」構圖，捕捉投手在投手丘上全力投球瞬間的側面視角，身體極限扭轉展現運動張力，球離手的動態模糊增添速度感。
  - **字體選用 (建議)**: 標題使用傾斜粗重無襯線體（如 *Impact*），數據與背面資訊使用壓縮等寬字體確保海量數據對齊。
  - **主圖片視覺**: 身穿道奇隊藍白球衣 17 號的日本投手，在球場聚光燈下的全力投球瞬間，動態特寫捕捉身體扭轉與快速球離手的張力動作。
  - **色調規劃**: 道奇藍 (Dodger Blue) 為主色調，搭配白色球衣，金色聚光燈光束營造夜間球場的戲劇氛圍，金屬銀點綴象徵榮譽。
- **繪圖 Prompt**: `Dynamic sports card illustration of a Japanese baseball pitcher in mid-pitch motion on the mound, extreme body rotation with powerful throwing stance, wearing Dodger blue and white baseball uniform number 17, dramatic stadium lighting with golden spotlight beams cutting through the night, motion blur on the fastball leaving the hand, intense focused athletic expression, vibrant Dodger blue and white color scheme with metallic silver and gold accents, detailed musculature and fabric folds, highly detailed sports photography style digital art, vertical card aspect ratio, 5:7 aspect ratio, portrait orientation, no text, no words, no letters, no card frame, no border, clean illustration`
