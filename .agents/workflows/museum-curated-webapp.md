...
version: 1.1.0
owner: PM Agent
triggers: [/museum-curated-webapp]
pipeline:
...
# /museum-curated-webapp — 博物館風格策展工作流
...
2. 閱讀相關 Skill 定義
   ...
   view_file .agents/skills/QA_LayoutAPI_Tester/SKILL.md
   view_file top50.md
   ```
...
**Skill**: `UIDesigner_MuseumTheme_Builder`
...
**Skill**: `Engineer_WebLayout_Builder`
