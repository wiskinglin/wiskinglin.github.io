...
當使用者輸入 `/cardbook` 或提到需要生成卡片時，依照以下流程進行：
...
2. **分析與四大美學維度設計**:
   - 讀取 [CB.md](file:///c:/Playground26/wiskinglin.github.io/_dev/cardbook/docs/CB.md)。
   - 讀取美學分析 [cardbook.md](file:///c:/Playground26/wiskinglin.github.io/_data/analysis/cardbook.md)。
...
4. **更新資料庫**:
   - 將卡片規格（含中英文名稱、美學類型、四大維度說明、最終採用的 Prompt 與圖片路徑）寫入或更新至 [CB.md](file:///c:/Playground26/wiskinglin.github.io/_dev/cardbook/docs/CB.md)。 // turbo
